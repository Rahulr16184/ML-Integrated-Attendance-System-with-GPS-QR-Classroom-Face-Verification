...
export function TeacherNav() {
  ...
  const menuItems = [
    { href: "/teacher-dashboard", label: "Dashboard", icon: Home, group: "main" },
  ...
  return (
    <>
      <SidebarMenu className="flex-1">
          <div className="p-2">
            <Button onClick={toggleTheme} className="w-full justify-start text-base p-2 h-auto" variant="default">
